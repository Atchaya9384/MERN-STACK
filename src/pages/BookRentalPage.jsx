...
const BookRentalPage = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:5021/api/books/category/children')
      .then(response => response.json())
      .then(data => {
        console.log('Fetched Data:', data);
        setBooks(data.childrenBooks || []); // Use the correct property from the backend response
      })
      .catch(error => {
    ...
    fetch('http://localhost:5021/api/books/category/topRated')
      .then(response => response.json())
      .then(data => {
  ...
  return (
    ...
    <div style={styles.page}>
      <div style={styles.sidebar}>
        <h2 style={styles.topRatedTitle}>Top Rated Books</h2>
      ...
      <div style={styles.mainContent}>
        <h2 style={styles.sectionTitle}>Books for Children</h2>
