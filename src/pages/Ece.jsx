...
const Ece = () => {
  ...
  useEffect(() => {
    // Fetch electronics books
    fetch('http://localhost:5021/api/ece/category/electronics')
      .then(response => response.json())
      .then(data => {
        console.log('Fetched Electronics Books:', data);
        setBooks(data.electronicsBooks || []);
      })
      .catch(error => {
        console.error('Error fetching electronics books:', error);
        setBooks([]);
      });

    // Fetch top-rated electronics books
    fetch('http://localhost:5021/api/ece/category/topRated')
      .then(response => response.json())
      .then(data => {
        console.log('Fetched Top Rated Electronics Books:', data);
        setTopRatedBooks(data.topRatedElectronicsBooks || []);
      })
      .catch(error => {
        console.error('Error fetching top-rated electronics books:', error);
        setTopRatedBooks([]);
      });
  }, []);
  ...
  return (
    ...
    <div style={styles.page}>
      <div style={styles.sidebar}>
        <h2 style={styles.topRatedTitle}>Top Rated Electronics Books</h2>
      ...
      <div style={styles.mainContent}>
        <h2 style={styles.sectionTitle}>Electronics Books</h2>
